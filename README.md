...
The presentation end - which implements a personalized template, services, validators, various helpers, options, a response handler, a toast notification library and other numerous extensions - of the project: https://github.com/mukumbasar/hr-api
